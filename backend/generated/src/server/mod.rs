    ...
    A: Api + 'static,
{
    ...
    Router::new()
        ...
        .route("/auth/logout",
            post(auth_logout_post::<I, A>)
        )
        .route("/auth/me",
            get(auth_me_get::<I, A>)
        )
        .route("/task",
            get(task_get::<I, A>).post(task_post::<I, A>)
        )
        .route("/task/:task_id",
    ...
    A: Api,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                AuthLoginPostResponse::Status401
                                                    (body)
                                                => {
                                                ...
                                                AuthLoginPostResponse::Status500
                                                    (body)
                                                => {
...
#[tracing::instrument(skip_all)]
fn auth_logout_post_validation(
) -> std::result::Result<(
), ValidationErrors>
{
    ...
    A: Api,
{
  ...
  let result = api_impl.as_ref().auth_logout_post(
      method,
      host,
      cookies,
  ).await;
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                AuthLogoutPostResponse::Status200
                                                    (body)
                                                => {
                                                ...
                                                AuthLogoutPostResponse::Status401
                                                    (body)
                                                => {
                                                ...
                                                AuthLogoutPostResponse::Status500
                                                    (body)
                                                => {
    ...
    A: Api,
{
  ...
  let result = api_impl.as_ref().task_get(
      method,
      host,
      cookies,
  ).await;
  ...
  let resp = match result {
    ...
    #[derive(validator::Validate)]
    #[allow(dead_code)]
    struct TaskPostBodyValidator<'a> {
            #[validate]
          body: &'a models::TaskCommand,
    }


#[tracing::instrument(skip_all)]
fn task_post_validation(
        body: models::TaskCommand,
) -> std::result::Result<(
        models::TaskCommand,
), ValidationErrors>
{
              let b = TaskPostBodyValidator { body: &body };
              b.validate()?;
...
/// TaskPost - POST /task
#[tracing::instrument(skip_all)]
async fn task_post<I, A>(
  method: Method,
  host: Host,
  cookies: CookieJar,
 State(api_impl): State<I>,
          Json(body): Json<models::TaskCommand>,
) -> Result<Response, StatusCode>
where 
    I: AsRef<A> + Send + Sync,
    A: Api,
{
  ...
  let result = api_impl.as_ref().task_post(
      method,
      host,
      cookies,
              body,
