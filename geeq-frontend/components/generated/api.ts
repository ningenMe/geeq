...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    authLoginPost: async (
      authLoginPostRequestBody: AuthLoginPostRequestBody,
  ...
  return {
    ...
    async authLoginPost(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Common200Response>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["DefaultApi.authLoginPost"]?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authLogoutPost(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DefaultApi.authLogoutPost"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async authMeGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<AuthMeGet200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authMeGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["DefaultApi.authMeGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    authLoginPost(
      ...
      return localVarFp
        .authLoginPost(authLoginPostRequestBody, options)
