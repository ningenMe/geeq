...
static GITHUB_OAUTH_CLIENT_ID: Lazy<String> = Lazy::new(|| env::var("GITHUB_OAUTH_CLIENT_ID").expect("env variable is not found"));
static GITHUB_OAUTH_CLIENT_SECRET: Lazy<String> = Lazy::new(|| env::var("GITHUB_OAUTH_CLIENT_SECRET").expect("env variable is not found"));
